    ...
    <div className="xl:py-[55.98px] xl:px-[43px]">
      <div className="bg-[#795CD0] w-full pt-[46.65px] pb-[99.48px] m-auto">
        <div className="text-center">
          ...
          <p className="text-[#fff] text-[17.49px]">
            Upgrade your subscription to gain unlimited access to prime
            resourses
          </p>
        </div>
        <div className="grid lg:grid-cols-3 items-center w-2/3 lg:w-[80%] xl:w-2/3 m-auto mt-[22.35px] gap-10 lg:gap-0 text-[10px]">
          <div className="h-[298.27px] overflow-auto no-scrollbar bg-white text-[#767676] py-[14.38px] px-[19px] rounded-[28.13px] font-semibold">
            <h3 className="pb-[20.28px] text-[#421196] text-[15.7px]">
              Freemium
            </h3>
            <p className="text-[26.16px] text-[#FBBC05]">FREE</p>
            <ul className="grid gap-[9.81px]">
              {fremiumLists.map((fremiumList, index) => (
                <div className="flex gap-4">
                  <span className="p-[1px] border border-[#421196] rounded-full h-max">
                    <TiTick style={{ color: "#421196" }} />
                  </span>
                  <li key={index} className="list-disc">
                    <span>{fremiumList}</span>
                  </li>
                </div>
              ))}
            </ul>
          ...
          <div className="h-[335.55px] overflow-auto no-scrollbar bg-premium-background text-white py-[24.98px] px-[17.17px] rounded-[28.13px] font-semibold">
            ...
            <ul className="grid gap-[9.81px] list-disc text-[10px]">
              {premiumLists.map((premiumList, index) => (
                <div className="flex gap-4">
                <span className="p-[1px] border border-[#FBE077] rounded-full h-max">
                  <TiTick style={{ color: "#FBE077" }} />
                </span>
                <li key={index} className="list-disc">
                  <span>{premiumList}</span>
                </li>
              </div>
              ))}
            </ul>
          ...
          <div className="h-[298.27px] overflow-auto no-scrollbar bg-white text-[#767676] py-[14.38px] px-[13.85px] rounded-[28.13px] font-semibold">
            ...
            <ul className="grid gap-[9.81px] list-disc">
              {silverLists.map((silverList, index) => (
                <div className="flex gap-4">
                <span className="p-[1px] border border-[#421196] rounded-full h-max">
                  <TiTick style={{ color: "#421196" }} />
                </span>
                <li key={index} className="list-disc">
                  <span>{silverList}</span>
                </li>
              </div>
              ))}
            </ul>
        ...
        <div className="flex justify-center">
          <button
            className="rounded-full text-[#421196] bg-[#ffcc00] px-[17.49px] mt-[23.68px] py-[7px]"
            onClick={homeSubscription}
          >
            Upgrade Plan
          </button>
        </div>
